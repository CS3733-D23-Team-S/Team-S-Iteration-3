...
public class PathfindingController {
	...
	@FXML
	MFXButton clearFieldsButton;
	@FXML
	GesturePane mapPane;
	@FXML
	public ComboBox<String> startingLocationList = new SearchableComboBox<>();
	@FXML
	public ComboBox<String> destinationList = new SearchableComboBox<>();
	@FXML
	public ComboBox<String> algList = new SearchableComboBox<>();
	@FXML
	MFXButton pathfindingToLogin;
	...
	@FXML
	MFXButton floor1Button;
	@FXML
	MFXButton floor2Button;
	@FXML
	MFXButton floor3Button;
	@FXML
	MFXButton floorL1Button;
	@FXML
	MFXButton floorL2Button;
	...
	ImageView homeIcon;
	@FXML
	Label startingLocationError;
	@FXML
	Label destinationError;
	@FXML
	Label textualDirections;
	@FXML
	ToggleSwitch displayLocationNamesToggle;
	@FXML
	ToggleSwitch displayAllNodesToggle;
  ...
  */
		...
		if (!startingLocationList.getSelectionModel().isEmpty()
			...
			for (int i = 0; i < pfe.getPathEntities().size() - 1; i++) {
				...
				if (thisFloor != nextFloor) {
					...
					if (nextFloor == Floor.Floor1) {
						importantCirclesF1PH.add(switchFloorsCircle);
						currFloor = "Floor 1";
					} else if (nextFloor == Floor.Floor2) {
						importantCirclesF2PH.add(switchFloorsCircle);
						currFloor = "Floor 2";
					} else if (nextFloor == Floor.Floor3) {
						importantCirclesF3PH.add(switchFloorsCircle);
						currFloor = "Floor 3";
					} else if (nextFloor == Floor.FloorL1) {
						importantCirclesFL1PH.add(switchFloorsCircle);
						currFloor = "Floor L1";
					} else if (nextFloor == Floor.FloorL2) {
						importantCirclesFL2PH.add(switchFloorsCircle);
						currFloor = "Floor L2";
					}
					los.add(currFloor);
				...
				if (prevDirection == null) {
                  ...
                  direction = switch (currDir) {
                    case "East", "Southeast", "Northeast" -> "right";
                    case "West", "Southwest", "Northwest" -> "left";
                    default -> "straight";
                  };
				} else if (prevDirection.equals("South")) {
                  direction = switch (currDir) {
                    case "East", "Southwest", "Northwest" -> "left";
                    case "West", "Southeast", "Northeast" -> "right";
                    default -> "straight";
                  };
				} else if (prevDirection.equals("West")) {
                  direction = switch (currDir) {
                    case "North", "Northeast", "Northwest" -> "right";
                    case "South", "Southwest", "Southeast" -> "left";
                    default -> "straight";
                  };
				} else if (prevDirection.equals("East")) {
                  direction = switch (currDir) {
                    case "North", "Northeast", "Northwest" -> "left";
                    case "South", "Southeast", "Southwest" -> "right";
                    default -> "straight";
                  };
	...
	public void clearFields() {
		...
		if (floor.getImage().equals(floor1)) {
          for (Circle floor1Circle : floor1Circles) {
            floor1Circle.setFill(Color.RED);
          }
			if (displayAllNodesToggle.isSelected()) {
				showLocationNames2();
			}
		} else if (floor.getImage().equals(floor2)) {
          for (Circle floor2Circle : floor2Circles) {
            floor2Circle.setFill(Color.RED);
          }
			if (displayAllNodesToggle.isSelected()) {
				showLocationNames2();
			}
		} else if (floor.getImage().equals(floor3)) {
          for (Circle floor3Circle : floor3Circles) {
            floor3Circle.setFill(Color.RED);
          }
			if (displayAllNodesToggle.isSelected()) {
				showLocationNames2();
			}
		} else if (floor.getImage().equals(floorL1)) {
          for (Circle floorL1Circle : floorL1Circles) {
            floorL1Circle.setFill(Color.RED);
          }
			if (displayAllNodesToggle.isSelected()) {
				showLocationNames2();
			}
		} else if (floor.getImage().equals(floorL2)) {
          for (Circle floorL2Circle : floorL2Circles) {
            floorL2Circle.setFill(Color.RED);
          }
			if (displayAllNodesToggle.isSelected()) {
				showLocationNames2();
			}
