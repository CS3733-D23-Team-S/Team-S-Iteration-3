...
public class FlowerRequesttableController {
  ...
  public void initialize() {
    ...
    TableColumn<FlowerDelivery, String> column2 = new TableColumn<>("Cart");
    column2.setCellValueFactory(new PropertyValueFactory<>("cart"));

    TableColumn<FlowerDelivery, Date> column3 = new TableColumn<>("Order Date");
    column3.setCellValueFactory(new PropertyValueFactory<>("orderdate"));

    TableColumn<FlowerDelivery, Time> column4 = new TableColumn<>("Order Time");
    column4.setCellValueFactory(new PropertyValueFactory<>("ordertime"));

    TableColumn<FlowerDelivery, String> column5 = new TableColumn<>("Room");
    column5.setCellValueFactory(new PropertyValueFactory<>("room"));

    TableColumn<FlowerDelivery, String> column6 = new TableColumn<>("Ordered By");
    column6.setCellValueFactory(new PropertyValueFactory<>("orderedby"));

    TableColumn<FlowerDelivery, String> column7 = new TableColumn<>("Assigned Employee");
    column7.setCellValueFactory(new PropertyValueFactory<>("assignedto"));

    TableColumn<FlowerDelivery, Status> column8 = new TableColumn<>("Order Status");
    column8.setCellValueFactory(new PropertyValueFactory<>("orderstatus"));

    TableColumn<FlowerDelivery, Double> column9 = new TableColumn<>("Cost");
