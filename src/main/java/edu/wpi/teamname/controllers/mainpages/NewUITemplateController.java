...
public class NewUITemplateController {
    ...
    public void gotoHomePage(){Navigation.navigate(Screen.HOME);}
    public void exitApp(){Platform.exit();}

    //public void back(){Navigation.navigate(Screen.);}
    //depends on each page
    public void gotoNavigation(){Navigation.navigate(Screen.PATHFINDING);}
    public void gotoSignage(){Navigation.navigate(Screen.SIGNAGE_PAGE);}
    public void gotoMealRequest(){Navigation.navigate(Screen.MEAL_DELIVERY1);}
    public void gotoRoomBooking(){Navigation.navigate(Screen.ROOM_BOOKING);}
    public void gotoFlowerRequest(){Navigation.navigate(Screen.FLOWER_DELIVERY);}
    public void gotoHelpPage(){Navigation.navigate(Screen.HELP_PAGE);}
