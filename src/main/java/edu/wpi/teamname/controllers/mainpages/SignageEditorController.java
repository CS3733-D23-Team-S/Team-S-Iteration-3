...
public class SignageEditorController {
	...
	@FXML
	private MFXButton AUBTN, RemBTN, ClearBTN, SubmitBTN;
	@FXML
	private MFXRectangleToggleNode Switch;
	@FXML
...
// check if textField1 is non-empty and enable/disable the button accordingly
		...
		Switch.selectedProperty().addListener((observable, oldValue, newValue) -> {
