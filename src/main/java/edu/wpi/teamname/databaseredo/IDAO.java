...
/**
 * Generalized DAO implementation class that helps with managing all of the DAOs and makes implementing the facade class
 * a lot easier
...
public interface IDAO<T, U> {
   ...
   * @param name the name of the database table. The name of the database is stored and accessed from dbConnection and
   *             then passed to the DAO
   */
